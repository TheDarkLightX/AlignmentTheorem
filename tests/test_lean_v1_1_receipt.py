...
from verification.run_lean_v1_1 import (
    EXPECTED_AXIOMS,
    PLACEHOLDER,
    PROOF_FILES,
    PROOF_ROOT,
...
RECEIPT = ROOT / "verification" / "receipts" / "lean_v1_1_v4.33.0.json"
CHECKER = ROOT / "verification" / "run_lean_v1_1.py"


class LeanV1_1ReceiptTests(unittest.TestCase):
