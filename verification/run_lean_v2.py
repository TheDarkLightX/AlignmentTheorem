#!/usr/bin/env python3
"""Build and grade the Version 2 Lean theorem with deterministic evidence."""
...
PROOF_ROOT = REPO_ROOT / "proofs" / "v2"
PROOF_FILES = (
    "AlignmentTheoremV2.lean",
    "AxiomAudit.lean",
    "lakefile.lean",
    "lake-manifest.json",
    "lean-toolchain",
...
EXPECTED_AXIOMS = {
    "AlignmentTheoremV2.admits_implies_every_obligation": ["propext"],
    "AlignmentTheoremV2.committed_action_is_policy_compliant": ["propext"],
    "AlignmentTheoremV2.rejected_settlement_is_noop": ["propext"],
    "AlignmentTheoremV2.accepted_settlement_conserves_reserve": ["propext"],
    "AlignmentTheoremV2.accepted_payout_is_funded": ["propext"],
    "AlignmentTheoremV2.epsilon_optimal_choice_is_compliant": [
        "propext",
        "Quot.sound",
    ],
    "AlignmentTheoremV2.finite_alignment_theorem": ["propext", "Quot.sound"],
    "AlignmentTheoremV2.reward_only_alignment_theorem": [
        "propext",
        "Quot.sound",
    ],
    "AlignmentTheoremV2.admitted_revision_preserves_constitution": [],
}
...
def run() -> dict[str, object]:
    ...
    return {
        "schema": "alignment-theorem-v2-lean-build-v1",
