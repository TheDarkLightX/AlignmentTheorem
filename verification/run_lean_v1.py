#!/usr/bin/env python3
"""Build and grade the reconstructed V1 Lean theorem."""
...
PROOF_ROOT = REPO_ROOT / "proofs" / "v1"
PROOF_FILES = (
    "AlignmentTheoremV1.lean",
    "AxiomAudit.lean",
    "lakefile.lean",
    "lake-manifest.json",
    "lean-toolchain",
...
EXPECTED_AXIOMS = {
    "AlignmentTheoremV1.tier_multiplier_of_excluded": ["propext", "Quot.sound"],
    "AlignmentTheoremV1.exclusion_opportunity_cost_normalization": [
        "propext",
        "Classical.choice",
        "Quot.sound",
    ],
    "AlignmentTheoremV1.strict_exclusion_margin_orders_utilities": [
        "propext",
        "Quot.sound",
    ],
    "AlignmentTheoremV1.v1_exclusion_alignment": ["propext", "Quot.sound"],
    "AlignmentTheoremV1.minimum_scarcity_multiplier_is_strict": ["propext"],
    "AlignmentTheoremV1.scarcity_below_minimum_is_not_strict": [
        "propext",
        "Quot.sound",
    ],
    "AlignmentTheoremV1.zero_deviation_needs_only_positive_scarcity_and_exposure": [],
    "AlignmentTheoremV1.unbounded_scarcity_eventually_establishes_v1_margin": [
        "propext"
    ],
    "AlignmentTheoremV1.common_scarcity_upside_cancels": [
        "propext",
        "Classical.choice",
        "Quot.sound",
    ],
...
def run() -> dict[str, object]:
    ...
    source = (PROOF_ROOT / "AlignmentTheoremV1.lean").read_text()
    ...
    return {
        "schema": "alignment-theorem-v1-lean-build-v1",
